...
`presentation.docx` (בשורש הריפו) הוא **המסמך העוגן**: ממנו נבנה האתר, והוא עצמו קובץ ההורדה
שמופיע בכפתור "הורדת המסמך (DOCX)" ב-HERO. מסמך אחד -> אתר + הורדה תמיד מסונכרנים.

1. עורכים את `presentation.docx` (Word).
