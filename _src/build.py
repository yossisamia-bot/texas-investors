...
.hero .dl{{display:inline-flex;align-items:center;gap:7px;margin-top:17px;padding:8px 16px;border:1.5px solid rgba(255,255,255,.5);border-radius:30px;color:#fff;text-decoration:none;font-size:14.5px;font-weight:600;transition:background .15s}}
.hero .dl:hover{{background:rgba(255,255,255,.12)}} .hero .dl svg{{width:15px;height:15px}}
...
<div class="hero">
  ...
  <div class="in">
    ...
    <a class="dl" href="presentation.docx" download="מצגת משקיעים - בתים חדשים בטקסס.docx" onclick="gtag('event','download_doc')"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>הורדת המסמך (DOCX)</a>
  </div>
</div>
